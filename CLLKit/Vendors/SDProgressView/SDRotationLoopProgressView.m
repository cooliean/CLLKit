...
// 加载时显示的文字
NSString * const SDRotationLoopProgressViewWaitingText = @"请稍候...";
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    return [self initWithFrame:frame backColor:[UIColor orangeColor]];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    attributes[NSForegroundColorAttributeName] = _backColor; //文字颜色
